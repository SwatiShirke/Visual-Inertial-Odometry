    ...
    for name in names:
        ...
        for Epochs in range(StartEpoch, NumEpochs):
            ...
            for PerEpochCounter in range(NumIterationsPerEpoch):
                IMU_train_batch , IMU_test_batch, pose_train_batch, pose_test_batch, start_index = GenerateBatch(Basepath, MiniBatchSize, TrainValSplit, start_index, IMU_data, pose_data)
                # Predict output with forward pass
